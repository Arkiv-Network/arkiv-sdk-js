...
[@arkiv-network/sdk](../../../index.md) / [clients/createWalletClient](../index.md) / createWalletClient

# Function: createWalletClient()

> **createWalletClient**\<`transport`, `chain`, `accountOrAddress`, `rpcSchema`\>(`parameters`): `object`

Defined in: [src/clients/createWalletClient.ts:44](https://github.com/Arkiv-Network/arkiv-sdk-js/blob/f49ca7fc2b8011c845d4dcdedd55114d03c0304f/src/clients/createWalletClient.ts#L44)
